export default [
    {
        "name": "poyo",
        "description": "the cool kid of the class",
        "links": [
            {
                "label": "website",
                "url": "https://poy.ooo"
    ...
    {
        "name": "maxpixels",
        "description": "idiot web developer & artist",
        "links": [
            {
                "label": "website",
    ...
    {
        "name": "jbcarreon123",
        "description": "a developer that does things",
        "links": [
            {
                "label": "website",
    ...
    {
        "name": "thinliquid",
        "description": "typecript/css wizard 🪫🪫🥀",
        "links": [
            {
                "label": "website",
    ...
    {
        "name": "ivory willows",
        "description": "\"hold on i'll think of a description later\"",
        "links": [
            {
                "label": "website",
